...
public static class AutogeneratedResourcesGenerator
{
    ...
    private static JsonObject ToRef(ResourceRef resourceRef, ScopeType targetScope)
    {
        ...
        var schemaPath = Utils.GetSchemaPath(resourceRef.ApiVersion, resourceRef.ProviderNamespace);
        return new JsonObject
        {
            ["$ref"] = $"https://schema.management.azure.com/schemas/{schemaPath}#/{section}/{resourceRef.DefinitionKey}",
        };
    }
}
